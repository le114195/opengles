...
GLuint gl_loadShader ( GLenum type, const char *shaderSrc )
{
    GLuint shader;
    GLint compiled;
...
GLuint gl_esLoadProgram ( const char *vertShaderSrc, const char *fragShaderSrc ) {
    ...
    vertexShader = gl_loadShader( GL_VERTEX_SHADER, vertShaderSrc );
    ...
    fragmentShader = gl_loadShader( GL_FRAGMENT_SHADER, fragShaderSrc );
